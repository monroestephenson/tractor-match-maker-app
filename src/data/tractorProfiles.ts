...
// Import the getImagePath function from utils.ts
import { getImagePath } from '../lib/utils';

// Helper function to wrap all image paths with getImagePath
const wrapImagePath = (path: string) => getImagePath(path);
...
export const tractorProfiles: TractorProfile[] = [
  {
    ...
    image: wrapImagePath("/tractor-pics/kubota_b8200_1.webp"),
    images: [
      wrapImagePath("/tractor-pics/kubota_b8200_1.webp"),
      wrapImagePath("/tractor-pics/KUBOTA_B8200_2.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-B8200-3.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-B8200-4.webp")
    ],
    make: "Kubota",
    model: "B8200",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/X-JD-4010-2WD-CANOPY-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/X-JD-4010-2WD-CANOPY-1.webp"),
      wrapImagePath("/tractor-pics/X-JD-4010-2WD-CANOPY-2.webp"),
      wrapImagePath("/tractor-pics/X-JD-4010-2WD-CANOPY-3.webp")
    ],
    make: "John Deere",
    model: "4010 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/OLIVER-STANDARD-88-DIESEL-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/OLIVER-STANDARD-88-DIESEL-1.webp"),
      wrapImagePath("/tractor-pics/OLIVER-STANDARD-88-DIESEL-2.webp"),
      wrapImagePath("/tractor-pics/OLIVER-STANDARD-88-DIESEL-3.webp")
    ],
    make: "Oliver",
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/MF-180-2WD-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/MF-180-2WD-1.webp"),
      wrapImagePath("/tractor-pics/MF-180-2WD-2.webp"),
      wrapImagePath("/tractor-pics/MF-180-2WD-3.webp")
    ],
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/MF-135-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/MF-135-1.webp"),
      wrapImagePath("/tractor-pics/MF-135-2.webp"),
      wrapImagePath("/tractor-pics/MF-135-3.webp")
    ],
    make: "Massey Ferguson",
    model: "135",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/MAHINDRA-4110-4WD-ROPS-W:LDR&BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/MAHINDRA-4110-4WD-ROPS-W:LDR&BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/MAHINDRA-4110-4WD-ROPS-W:LDR&BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/MAHINDRA-4110-4WD-ROPS-W:LDR&BUCKET-3.webp"),
      wrapImagePath("/tractor-pics/MAHINDRA-4110-4WD-ROPS-W:LDR&BUCKET-.webp")
    ],
    make: "Mahindra",
    model: "4110 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/LANDINI-80-2WD-C:A-W:LDR&BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/LANDINI-80-2WD-C:A-W:LDR&BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/LANDINI-80-2WD-C:A-W:LDR&BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/LANDINI-80-2WD-C:A-W:LDR&BUCKET-3.webp")
    ],
    make: "Landini",
    model: "80 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/KUBOTA-M6800-W:-LDR&BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/KUBOTA-M6800-W:-LDR&BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-M6800-W:-LDR&BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-M6800-W:-LDR&BUCKET-3.webp")
    ],
    make: "Kubota",
    model: "M6800",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/KUBOTA-L2900-4WD-ROPS-W:-LDR-AND-BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/KUBOTA-L2900-4WD-ROPS-W:-LDR-AND-BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-L2900-4WD-ROPS-W:-LDR-AND-BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-L2900-4WD-ROPS-W:-LDR-AND-BUCKET-3.webp")
    ],
    make: "Kubota",
    model: "L2900 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/KUBOTA-L2800-4WD-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/KUBOTA-L2800-4WD-1.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-L2800-4WD-2.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-L2800-4WD-3.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-L2800-4WD-4.webp")
    ],
    make: "Kubota",
    model: "L2800 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/KUBOTA-B21-TLB-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/KUBOTA-B21-TLB-1.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-B21-TLB-2.webp"),
      wrapImagePath("/tractor-pics/KUBOTA-B21-TLB-3.webp")
    ],
    make: "Kubota",
    model: "B21 TLB",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-5420-2WD-ROPS-W:LDR&HAY-FORK-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-5420-2WD-ROPS-W:LDR&HAY-FORK-1.webp"),
      wrapImagePath("/tractor-pics/JD-5420-2WD-ROPS-W:LDR&HAY-FORK-2.webp"),
      wrapImagePath("/tractor-pics/JD-5420-2WD-ROPS-W:LDR&HAY-FORK-3.webp")
    ],
    make: "John Deere",
    model: "5420 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-5400-2WD-CANOPY-W:LDR&BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-5400-2WD-CANOPY-W:LDR&BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/JD-5400-2WD-CANOPY-W:LDR&BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/JD-5400-2WD-CANOPY-W:LDR&BUCKET-3.webp")
    ],
    make: "John Deere",
    model: "5400 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-5075E-4WD-C:A-W:LDR&BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-5075E-4WD-C:A-W:LDR&BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/JD-5075E-4WD-C:A-W:LDR&BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/JD-5075E-4WD-C:A-W:LDR&BUCKET-3.webp")
    ],
    make: "John Deere",
    model: "5075E 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-5055E-4WD-CANOPY-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-5055E-4WD-CANOPY-1.webp"),
      wrapImagePath("/tractor-pics/JD-5055E-4WD-CANOPY-2.webp"),
      wrapImagePath("/tractor-pics/JD-5055E-4WD-CANOPY-3.webp"),
      wrapImagePath("/tractor-pics/JD-5055E-4WD-CANOPY-4.webp")
    ],
    make: "John Deere",
    model: "5055E 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-4240-2WD-C:A-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-4240-2WD-C:A-1.webp"),
      wrapImagePath("/tractor-pics/JD-4240-2WD-C:A-2.webp"),
      wrapImagePath("/tractor-pics/JD-4240-2WD-C:A-3.webp")
    ],
    make: "John Deere",
    model: "4240 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-4010-2WD-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-4010-2WD-1.webp"),
      wrapImagePath("/tractor-pics/JD-4010-2WD-2.webp"),
      wrapImagePath("/tractor-pics/JD-4010-2WD-3.webp")
    ],
    make: "John Deere",
    model: "4010 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/JD-2040-2WD-W:-LDR-AND-BUCKET-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/JD-2040-2WD-W:-LDR-AND-BUCKET-1.webp"),
      wrapImagePath("/tractor-pics/JD-2040-2WD-W:-LDR-AND-BUCKET-2.webp"),
      wrapImagePath("/tractor-pics/JD-2040-2WD-W:-LDR-AND-BUCKET-3.webp"),
      wrapImagePath("/tractor-pics/JD-2040-2WD-W:-LDR-AND-BUCKET-4.webp")
    ],
    make: "John Deere",
    model: "2040 2WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/HITACHI-27U-EXCAVATOR-HYDRAULIC-THUMB-AND-2-BUCKETS-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/HITACHI-27U-EXCAVATOR-HYDRAULIC-THUMB-AND-2-BUCKETS-1.webp"),
      wrapImagePath("/tractor-pics/HITACHI-27U-EXCAVATOR-HYDRAULIC-THUMB-AND-2-BUCKETS-2.webp"),
      wrapImagePath("/tractor-pics/HITACHI-27U-EXCAVATOR-HYDRAULIC-THUMB-AND-2-BUCKETS-3.webp")
    ],
    make: "Hitachi",
    model: "27U Excavator",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/FORD-445D-4-POST-CANOPY-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/FORD-445D-4-POST-CANOPY-1.webp"),
      wrapImagePath("/tractor-pics/FORD-445D-4-POST-CANOPY-2.webp"),
      wrapImagePath("/tractor-pics/FORD-445D-4-POST-CANOPY-3.webp")
    ],
    make: "Ford",
    model: "445D",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/CASE-D35-4WD-ROPS-W:-LDR-AND-HAY-SPEER-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/CASE-D35-4WD-ROPS-W:-LDR-AND-HAY-SPEER-1.webp"),
      wrapImagePath("/tractor-pics/CASE-D35-4WD-ROPS-W:-LDR-AND-HAY-SPEER-2.webp"),
      wrapImagePath("/tractor-pics/CASE-D35-4WD-ROPS-W:-LDR-AND-HAY-SPEER-3.webp")
    ],
    make: "Case",
    model: "D35 4WD",
    responseMessages: [
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/CASE-CX210-EXCAVATOR-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/CASE-CX210-EXCAVATOR-1.webp"),
      wrapImagePath("/tractor-pics/CASE-CX210-EXCAVATOR-2.webp"),
      wrapImagePath("/tractor-pics/CASE-CX210-EXCAVATOR-3.webp")
    ],
    make: "Case",
  ...
  },
  {
    ...
    image: wrapImagePath("/tractor-pics/2022-CAN-AM-DEFENDDER-MAX-1000-SIDE-BY-SIDE-NO-TITLE-1604-MILES-WE-DO-NOT-GAURANTEE-MILES-1.webp"),
    images: [
      wrapImagePath("/tractor-pics/2022-CAN-AM-DEFENDDER-MAX-1000-SIDE-BY-SIDE-NO-TITLE-1604-MILES-WE-DO-NOT-GAURANTEE-MILES-1.webp"),
      wrapImagePath("/tractor-pics/2022-CAN-AM-DEFENDDER-MAX-1000-SIDE-BY-SIDE-NO-TITLE-1604-MILES-WE-DO-NOT-GAURANTEE-MILES-2.webp"),
      wrapImagePath("/tractor-pics/2022-CAN-AM-DEFENDDER-MAX-1000-SIDE-BY-SIDE-NO-TITLE-1604-MILES-WE-DO-NOT-GAURANTEE-MILES-3.webp")
    ],
    make: "Can-Am",
